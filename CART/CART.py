...
def registerSampleData():
    ...
    SampleData.SampleDataLogic.registerCustomSampleDataSource(
        ...
        thumbnailFileName=os.path.join(iconsPath, "CART1.png"),
        # Download URL and target file name
        uris="https://github.com/Slicer/SlicerTestingData/releases/download/SHA256/998cb522173839c78657f4bc0ea907cea09fd04e44601f17c82ea27927937b95",
        fileNames="CART1.nrrd",
    ...
    SampleData.SampleDataLogic.registerCustomSampleDataSource(
        ...
        category="CART",
        sampleName="CART2",
        thumbnailFileName=os.path.join(iconsPath, "CART2.png"),
        # Download URL and target file name
        uris="https://github.com/Slicer/SlicerTestingData/releases/download/SHA256/1a64f3f422eb3d1c9b093d1a18da354b13bcf307907c66317e2463ee530b7a97",
        fileNames="CART2.nrrd",
...
class CARTLogic(ScriptedLoadableModuleLogic):
    ...
    def getParameterNode(self):
        return CARTParameterNode(super().getParameterNode())
...
class CARTTest(ScriptedLoadableModuleTest):
    """
    ...
    def test_CART1(self):
        ...
        registerSampleData()
        inputVolume = SampleData.downloadSample("CART1")
